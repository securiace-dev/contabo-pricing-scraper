...
namespace ContaboVps\Tests;

use ContaboVps\ConfigOptionResolver;
use ContaboVps\ContaboApiClient;
use ContaboVps\ContaboAuth;
use ContaboVps\ContaboInstanceMapper;
use ContaboVps\ImageResolver;
use ContaboVps\InstanceLinker;
use ContaboVps\InstanceService;
use ContaboVps\Runtime;
use ContaboVps\SecretManager;
 ...
 * functions (contabo_vps_CreateAccount, …) are what gets exercised.
 */
final class Harness
{
