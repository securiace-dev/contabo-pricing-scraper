...
/**
 * Exercises the REAL securiacevps_CreateAccount entry function end-to-end
...
final class CreateFlowTest extends TestCase
{
    ...
    public function testFreshCreateProvisionsStoresAndTags(): void
    {
        ...
        $result = securiacevps_CreateAccount(Harness::params(['billingcycle' => 'Annually']));
    ...
    public function testGeneratedPasswordIsPersistedEncrypted(): void
    {
        ...
        $result = securiacevps_CreateAccount(Harness::params(['password' => '']));
